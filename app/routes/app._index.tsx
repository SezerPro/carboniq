...
const MODULES = [
  ...
  { icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>', color: "#64748B", bg: "rgba(100,116,139,.08)", t: "API Docs", d: "Documentation API", r: "/app/api-docs", gate: "dashboard" as const },
];
